...
const INITIAL_STATE: CheckoutFormDataType = {
  address: '',
  city: '',
  state: '',
  error: null,
...
const CheckoutForm = () => {
  const [data, setData] = useState<CheckoutFormDataType>(INITIAL_STATE)
  const [loading, setLoading] = useState(false)
  const { user, cart, resetCart, toggleShowCart } = useAppContext()
  ...
  const submitOrder: React.FormEventHandler<HTMLFormElement> = async (
